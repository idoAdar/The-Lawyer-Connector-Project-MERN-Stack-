...
const CreateProfile = props => {
    ...
    const [formState, setFormState] = useState({
        company: !props.isLoading ? props.profile.company : '',
        websites: !props.isLoading ? props.profile.websites : '',
        location: !props.isLoading ? props.profile.location : '',
        status: !props.isLoading ? props.profile.status : '',
        skills: !props.isLoading ? props.profile.skills : '',
        bio: !props.isLoading ? props.profile.bio : '',
        youtube: !props.isLoading && props.profile.social ? props.profile.social.youtube : '',
        twitter: !props.isLoading && props.profile.social ? props.profile.social.twitter : '',
        facebook: !props.isLoading && props.profile.social ? props.profile.social.facebook : '',
        linkedin: !props.isLoading && props.profile.social ? props.profile.social.linkedin : '',
        instegram: !props.isLoading && props.profile.social ? props.profile.social.instegram : '',
    });
    ...
    return (
        <section className={classes.create_profile_container}>
            ...
            <form onSubmit={(e) => save(e)}>
                ...
                <div className={classes.input_field}>
                    <input onChange={e => updateState(e)} value={formState.websites} type="text" placeholder="Website" name="websites"/>
